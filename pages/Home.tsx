    ...
    backgroundPosition: "center",
      ...
      >
        <div className="relative z-10 max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center text-white">
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-6xl font-black mb-6 leading-tight">
              <span className="text-white">
                {content.homeHeroTitle || BRAND.heroTitle}
              </span>
            </h1>
          ...
          <div className="hidden lg:block relative">
            <img
              src={content.homeHeroSideImage || heroImpact}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          <div className="grid grid-cols-2 gap-6">
            <img
              src={content.homeSnapshotImage1 || snap1}
              alt="Community"
              className="rounded-xl shadow-xl"
            />
            <img
              src={content.homeSnapshotImage2 || snap2}
              alt="Education"
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-8 italic">
              {content.homeWhoWeAreText ||
                "Poverty, early marriage, teenage pregnancies, gender based violence, HIV and AIDS, and low participation in post-primary education are some of the situations attributed to Butaleja District. Adolescent girls, in particular, face multiple vulnerabilities."}
            </p>
            <p className="text-slate-600 text-lg leading-relaxed mb-8 italic">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 text-center mb-12">
          <h2 className="text-3xl font-black mb-4 text-red-900">
            {content.homeWhatWeDoTitle || "What We Do"}
          </h2>
          <p className="mx-auto max-w-3xl text-sm leading-relaxed text-slate-500">
            {content.homeWhatWeDoText ||
              "Our programs are designed to protect children, strengthen families, and create opportunities for lasting community change."}
          </p>
          ...
          {(programs.length
            ...
            : [
                {
                  ...
                  description: "Scholarship, mentorship, and school materials",
                  image: prog1,
                },
                {
                  id: "p2",
                  name: "Community Welfare",
                  description: "Household support and emergency response",
                  image: prog2,
                },
                {
                  id: "p3",
                  name: "Environmental Action",
                  description: "Tree planting and climate awareness",
                  image: prog3,
                },
                {
                  id: "p4",
                  name: "Health Campaigns",
                  description: "Awareness, sanitation, and outreach",
                  image: prog4,
                },
              ]
          ).map((program: any, i) => (
            ...
            >
              <div className="h-48 relative">
                <img
                  src={
                    (i === 0 && content.homeProgramImage1) ||
                    (i === 1 && content.homeProgramImage2) ||
                    (i === 2 && content.homeProgramImage3) ||
                    (i === 3 && content.homeProgramImage4) ||
                    program.image ||
                    program.img
                  }
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              {content.homeVisionTitle || "Vision for Tomorrow"}
            </h2>
            <p className="text-slate-600 text-lg leading-relaxed mb-8">
              {content.homeVisionText ||
          ...
          <div className="relative">
            ...
            ></div>
            <img
              src={content.homeVisionImage || vision}
              alt="Future Vision"
