...
const News: React.FC = () => {
  ...
  const isAdmin =
    !!currentUser &&
    [UserRole.SUPER_ADMIN, UserRole.MID_ADMIN, UserRole.STAFF_ADMIN].includes(
      currentUser.role,
    );
  ...
  const handleDelete = (id: string) => {
    if (
      ...
      notify(
        `Deleting post ${id}. In a production deployment this would call the CMS API.`,
      );
    }
  };
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Header */}
      <div className="py-24 text-center text-white bg-red-950">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto font-medium">
            Stay updated with our latest activities, stories of impact, and
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
              ...
              {displayedNews.map((post) => (
                ...
                >
                  ...
                  <div className="p-10 flex flex-col flex-grow">
                    ...
                    <h3
                      className="text-2xl font-black mb-4 line-clamp-2 leading-tight group-hover:text-orange-600 transition-colors"
                    ...
                    <div className="mt-auto pt-6 border-t border-slate-50 flex flex-wrap gap-2 mb-6">
                      {post.tags.map((tag) => (
                        <span
                          key={tag}
                          className="text-[9px] font-bold text-slate-400 uppercase tracking-widest bg-slate-50 px-3 py-1 rounded-full border border-slate-100"
                        >
                          #{tag}
                        </span>
                      ))}
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-slate-400 text-lg leading-relaxed">
                Never miss a story. Join our community of 2,000+ supporters and
                get our latest impact reports and news delivered to your inbox.
              </p>
            </div>
            <div>
              <form
        ...
        <div className="mt-32 text-center max-w-3xl mx-auto">
          ...
          <p className="text-slate-500 mb-8 leading-relaxed">
            Are you a journalist or researcher looking for more information
            about Naanghirisa's work? Please reach out to our communications
            department for press kits, high-res photos, and interview requests.
          </p>
          <a
          ...
          >
            <i className="fas fa-envelope text-orange-500"></i> Contact Press
            Team
          </a>
        </div>
      </div>
