            ...
            <div className="grid sm:grid-cols-2 gap-6 mt-10">
              <div className="p-6 rounded-2xl bg-slate-50 border items-center">
                ...
                <p className="text-sm text-slate-600">
                  {content.aboutMission || 'To empower vulnerable children and communities through education, health, and sustainable initiatives.'}
                </p>
              </div>
              <div className="p-6 rounded-2xl bg-slate-50 border">
                ...
                <p className="text-sm text-slate-600">
                  {content.aboutVision || 'A resilient, educated, and self-sustaining Butaleja community.'}
                </p>
              </div>
            </div>
          </div>
