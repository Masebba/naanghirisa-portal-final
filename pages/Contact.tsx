        ...
        <div className="grid lg:grid-cols-2 gap-20">
          <div>
            ...
            <p className="text-lg text-slate-600 mb-12 leading-relaxed">
              We are here to help. Whether you're a potential donor, a
              volunteer, or a community member in need, our team is ready to
              listen and support.
            </p>
            ...
            <div className="space-y-10">
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-slate-600 font-medium">
                    Plot 12, Community Link Road, HQ District, Butaleja, Uganda
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-slate-600 font-medium">
                    info@naanghirisa.org
                    <br />
                    support@naanghirisa.org
                  </p>
                </div>
              </div>
            </div>
