...
const Contact: React.FC = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="py-24 text-center text-slate-900 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-20">
          <div>
            <h2
              className="text-4xl font-black mb-8 uppercase tracking-tighter"
            ...
            <p className="text-lg text-slate-600 mb-12 leading-relaxed">
              {content.contactIntro ||
                "We are here to help. Whether you are a donor, a volunteer, or a community member in need, our team is ready to listen and support."}
            </p>

            <div className="space-y-10">
              <div className="flex items-start gap-6 group">
                <div
                  className="w-14 h-14 bg-red-50 text-red-900 rounded-2xl flex items-center justify-center shrink-0 transition-colors group-hover:bg-orange-50"
                  style={{ color: COLORS.primary }}
                >
                  <i className="fas fa-map-marker-alt text-xl"></i>
                </div>
                <div>
                  <h4 className="font-black text-slate-900 uppercase tracking-widest text-xs mb-1">
                    Our Location
                  </h4>
                  <p className="text-slate-600 font-medium">
                    {content.contactAddress || content.footerAddress}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-slate-600 font-medium">
                    {content.contactPhone1 || content.footerPhone}
                    <br />
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-slate-600 font-medium">
                    {content.contactEmailSupport || content.footerEmail}
                    <br />
                    {content.contactEmailEnquiry || ""}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <a
                    key={i}
                    href="#"
                    className={`w-12 h-12 rounded-xl text-white flex items-center justify-center transition-transform hover:scale-110 shadow-md ${social.color}`}
                  >
            ...
            {sent ? (
              <div className="rounded-[2rem] border border-emerald-200 bg-emerald-50 p-8 text-center">
                ...
                <p className="mt-3 text-sm leading-relaxed text-slate-600">
                  Thanks for reaching out. Your message has been saved in the
