  ...
  return (
    <nav className="sticky top-0 z-[100] bg-white/95 backdrop-blur border-b border-slate-200 shadow-sm">
      <div className="max-w-8xl mx-auto px-4">
        <div className="flex justify-between h-16 md:h-18 items-center text-slate-700">
          {/* Logo */}
          <Link to="/" className="flex items-center">
            <img src={logo} alt="Naanghirisa" className="h-12 md:h-14 w-auto" />
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            {navItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className={`text-[10px] font-semibold uppercase tracking-[0.18em] transition-colors pb-1 border-b-2
                ${
            ...
            <Link
              to="/login"
              className="px-4 py-2 text-[10px] font-black text-white rounded-full shadow-sm border border-slate-200 bg-red-900 hover:bg-red-800 transition-all"
            >
              DONOR PORTAL
            </Link>
          </div>
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center">
              <img
                src={logo}
                alt="Naanghirisa"
                className="h-10 md:h-16 w-auto items-center justify-center invert-[30%]
...
const pageMetaMap: Record<string, { title: string; description: string }> = {
  "/": {
    title: "Naanghirisa | Home",
    description:
      "Naanghirisa supports vulnerable children and communities through education, welfare, and empowerment.",
  },
  "/about": {
    title: "About Naanghirisa",
    description:
      "Learn about Naanghirisa, our story, mission, and the people driving the organisation forward.",
  },
  "/programs": {
    title: "Programs | Naanghirisa",
    description:
      "Explore Naanghirisa programs and initiatives focused on education, welfare, and community empowerment.",
  },
  "/transparency": {
    title: "Transparency | Naanghirisa",
    description:
      "Review approved financial records, accountability reports, and public transparency updates.",
  },
  "/campaigns": {
    title: "Campaigns | Naanghirisa",
    description:
      "Follow active campaigns, community projects, and impact work at Naanghirisa.",
  },
  "/news": {
    title: "News | Naanghirisa",
    description:
      "Read the latest Naanghirisa news, stories, and organisation updates.",
  },
  "/contact": {
    title: "Contact Naanghirisa",
    description:
      "Reach Naanghirisa through our public contact channels and support team.",
  },
  "/volunteer": {
    title: "Volunteer | Naanghirisa",
    description:
      "Apply to volunteer and support Naanghirisa community initiatives.",
  },
  "/donate": {
    title: "Donate | Naanghirisa",
    description:
      "Support Naanghirisa campaigns and community work through secure giving.",
  },
};
...
const getMetaForPath = (path: string) => {
  if (path.startsWith("/campaigns/"))
    return {
      title: "Campaign Details | Naanghirisa",
      description:
        "View campaign details and progress updates from Naanghirisa.",
    };
  if (path.startsWith("/news/"))
    return {
      title: "News Details | Naanghirisa",
      description: "Read a detailed Naanghirisa news post or story.",
    };
  if (path.startsWith("/programs/"))
    return {
      title: "Program Details | Naanghirisa",
      description: "View Naanghirisa program information and impact details.",
    };
  return (
    pageMetaMap[path] || {
      title: "Naanghirisa Organisation",
      description: "Naanghirisa Organisation portal and public website.",
    }
  );
};
